          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <span className="text-sm font-medium text-gray-700 whitespace-nowrap">7. Customer Pickup Allowances:</span>
                <div className="flex gap-3">
                  <label className="flex items-center gap-1.5 text-sm text-gray-700 cursor-pointer">
                    <input
                      type="radio"
                      name="customerPickup"
                      checked={termsData.hasCustomerPickup === "yes"}
                      onChange={() => update("hasCustomerPickup", "yes")}
                    />
                    Yes
                  </label>
                  <label className="flex items-center gap-1.5 text-sm text-gray-700 cursor-pointer">
                    <input
                      type="radio"
                      name="customerPickup"
                      checked={termsData.hasCustomerPickup === "no"}
                      onChange={() => {
                        onChange({ ...termsData, hasCustomerPickup: "no", customerPickupAllowances: "" })
                      }}
                    />
                    No
                  </label>
